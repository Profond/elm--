...
async function lottery(_0x441cb5) {
  ...
  const _0x4e1126 = getToken(_0x441cb5),
    ...
    _0x5adac6 = {
      "url": "http://59.82.44.221/gw/mtop.koubei.interactioncenter.platform.right.lottery/1.0/?jsv=2.6.1&appKey=12574478&t=" + _0x41dbe8 + "&sign=" + _0x325758 + "&api=mtop.koubei.interactioncenter.platform.right.lottery&v=1.0&type=originaljson&dataType=json",
      "method": "POST",
      "headers": _0x25e489,
      "body": _0x43aab7
    };
